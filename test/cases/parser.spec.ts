...
describe('Parser', () => {
	...
	describe('#parse module.export', () => {
		...
		describe('when exported simple', () => {
			test('should parse function annotations', async () => {
			...
			test('should parse async function annotations', async () => {
			...
			test('should parse class annotations', async () => {
			...
			test('should not parse if exported without annotations', async () => {
		...
		describe('when exported functions', () => {
			test('should parse if exported as property', async () => {
			...
			test('should parse if exported as property (async)', async () => {
			...
			test('should parse if exported as properties', async () => {
			...
			test('should parse if exported as properties (async)', async () => {
		...
		describe('when exported classes', () => {
			...
			test('should not parse imported class', async () => {
